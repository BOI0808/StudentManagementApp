...
// API lấy danh sách môn học (Dùng cho BM4, BM9) (done)
...
// API Báo cáo tổng kết môn (Hiện thực hóa BM10 & QĐ10) (done)
...
// API Tiếp nhận học sinh (Hiện thực hóa Biểu mẫu 5 & Quy định 4, 5) (done)
...
// API Cập nhật quy định (Thay đổi tham số) (done)
